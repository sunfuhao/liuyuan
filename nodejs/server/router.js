...
router.get('/cha', function (req, res) {
	...
	var  sql_cha = "select * from " + name_biao + " WHERE "  +keys 
...
router.get('/cha_ziji', function (req, res) {
	pool("select * from userinfo ", [1], function(err,results,fields){  
	    //do something  
	    console.log(results)
	      res.send({data:results,msg:'ok'})
